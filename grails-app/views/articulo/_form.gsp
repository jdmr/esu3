...
<div class="row-fluid">
    <div class="span12 fieldcontain ${hasErrors(bean: articuloInstance, field: 'titulo', 'error')} required">
        ...
        <g:textField name="titulo" required="" value="${articuloInstance?.titulo}" class="span12" />
    </div>
</div>
...
<div class="row-fluid">
    <div class="span12 fieldcontain ${hasErrors(bean: articuloInstance, field: 'autor', 'error')} required">
        ...
        <g:select id="autor" name="autor.id" from="${usuarios}" optionKey="id" required="" value="${articuloInstance?.autor?.id}" class="many-to-one span12"/>
    </div>
</div>
