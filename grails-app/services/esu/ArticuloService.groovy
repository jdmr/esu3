...
class ArticuloService {
    ...
    def profundiza(String anio, String trimestre, String leccion, String tema) {
        Integer aniol = new Integer(anio)
        Publicacion publicacion = Publicacion.find("from Publicacion where anio = :anio and trimestre = :trimestre and leccion = :leccion and tema = :tema and tipo = :tipo and estatus = 'PUBLICADO'", [anio: aniol, trimestre: trimestre, leccion: leccion, tipo: 'dialoga', tema: tema])
        if (publicacion) {
